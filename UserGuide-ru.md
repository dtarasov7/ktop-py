...
| Workloads / Events | workloads, которые не ready, и Kubernetes Warning events |
...
JSON включает cluster metadata, nodes, pods, containers, metrics status, warnings и loaded timestamp.
